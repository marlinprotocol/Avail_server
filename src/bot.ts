...
const public_input = { public: '1u16' };
const secret = {
  network: '1u16',
  auth: {
    requests: [
      {
        ...
        inputs: ['aleo1nuh30tkffqcvme0633uphzv2hxv06sr36qs6qgf9zm4asktfyy9qgmxwwm', '100000u64'],
        signature:
          'sign1nx64532kqlx0dnvn3hdtnj3hu39a4nn7gd9qz2ertaw6574x6up6nv5f7dzmxufg6gam4xrnm4anysl7ulpclwvms8yu5fdvgu5agq564gyzwuc3q0wpn9fqx6zxdr5ztsa693khtz24uzp0vtgazyx4pa5t0dhctgx0u6mh4tx4rkd88ylmmpz76kq0w6hvr57y5gua55nq7vtekqn',
    ...
    requests: [
      {
        ...
        inputs: ['297000u64', '297000u64', '127287298127101328958820546105779762806810290041746964330950157926712686859field'],
        signature:
          'sign14ak3820g0fww6gn4ngjrttc7pqmu5cs767f0j6xp7hr0g6aukvqwyehp64f3rv0v5qjmt5gf5czga7eqp85ver6syzl9zfn87ysa2qv64gyzwuc3q0wpn9fqx6zxdr5ztsa693khtz24uzp0vtgazyx4pa5t0dhctgx0u6mh4tx4rkd88ylmmpz76kq0w6hvr57y5gua55nq7z2e5k7',
        sk_tag: '6879607582454541113355099157081992473302302532410024958090918311816161735890field',
...
const createAskTest = async () => {
  ...
  const matchingEngineKey = (await kalypso.MarketPlace().readMePubKeyInContract()).toString();
  ...
  let server_response = await fetch(config.APP_URL + '/proverEncryptedRequestTx', {
    method: 'POST',
    headers: {
  ...
  if (!server_response.ok) {
    ...
    throw new Error('Failed fetching proof');
  }
  return server_response.json();
};

function getRandomDelay(): number {
  return Math.floor(Math.random() * (240000 - 60000 + 1)) + 60000;
}

async function main(): Promise<never> {
  while (true) {
    createAskTest().then(console.log);
    const randomDelay = getRandomDelay(); // Get random delay between 1-4 minutes
